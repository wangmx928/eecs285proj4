...
public class ClientServerSocket
{
  ...
  private ManagerForm parentManagerWindow;
  ...
  public void startClient(String incName, ClientForm inclientForm)
  {
    try
    {
      ...
      {
        System.out.println("sent data from client \"" + incName
            + " \" successfully");
      }
  ...
  public void startServer(ManagerForm inparentMangerWindow)
  {
    parentManagerWindow = inparentMangerWindow;
